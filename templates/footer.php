        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="fw-bold text-primary mb-4">Work<span class="text-white">Wise</span></h1>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>Wingsxpress, Magsaysay ave</p>
                    <p><i class="fa fa-phone-alt me-3"></i>+63 910 89393</p>
                    <p><i class="fa fa-envelope me-3"></i>contactus@workwise.com</p>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        Designed By <a href="https://fredoware.com">Fredoware Software Development</a>
                    </div>
                </div>
            </div>
        </div>
